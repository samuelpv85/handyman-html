-- ========================================================================
-- DISEÑO DE BASE DE DATOS MARIADB PARA SISTEMA DE RESEÑAS DE HANDYMAN
-- ========================================================================
...
(4, 2, 'Cabinet Renovation', 'completed', '2023-06-10', '2023-06-18'),
(5, 2, 'Custom Shelving', 'completed', '2023-06-25', '2023-07-05'),
(6, 3, 'Bathroom Remodeling', 'completed', '2023-08-01', '2023-08-12');
...
(4, 4, 2, 5, 'I needed to renovate my kitchen cabinets and Handyman did an amazing job. They were very professional from start to finish and completed the work ahead of schedule. The quality of their carpentry work is exceptional.', TRUE, TRUE, '2023-06-18'),
...
(6, 6, 3, 4.5, 'We hired Handyman to remodel our bathroom and they did a fantastic job. The tile work is beautiful and the fixtures were installed perfectly. They were very attentive to our needs and made sure everything was exactly as we wanted.', TRUE, TRUE, '2023-08-12');
